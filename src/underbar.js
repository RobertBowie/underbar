(function() {
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(previous, value) {
  ...
  _.memoize = function(func) {
    ...
    return function() {
      var arg = arguments[0];
      if (!(arg in calledWithArgs)) {
        calledWithArgs[arg] = func.apply(this, arguments);
      }
      return calledWithArgs[arg];
    }
  };
  ...
  _.delay = function(func, wait) {
    var delayedArgs = [].slice.call(arguments, 2);
    setTimeout(function(){
      func.apply(this, delayedArgs);
    }, wait);
  };
  ...
  _.shuffle = function(array) {
    var arr = array.slice();
    return _.map(array, function(value, index, collection) {
      var tempIndex = Math.floor(Math.random() * arr.length);
      var remove = arr.splice(tempIndex, 1);
      return remove[0];
    });
  };
